...
public class CameraShaker : MonoBehaviour
{
    ...
    public Transform monsterCanvas;
    //
    private Vector3 battlePos;
    private Vector3 monsetPos;

    private void Awake()
    {
        battlePos = battleCanvas.position;
        monsetPos = monsterCanvas.position;
    }
    ...
    {
        battleCanvas.position = battlePos;
        monsterCanvas.position = monsetPos;
        isShake = false;
    }
